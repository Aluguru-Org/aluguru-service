    ...
    public static class Abstractions
    {
        ...
        private static void ConfigureSwaggerOptions(SwaggerGenOptions options)
        {
            ...
            {    
                Version = "v1",
                Title = "Mubbi API",                 
                Description = "This is the development mubbi-service iteractive documentation. Use this to correctly integrate your system to our backend.\r\n" +
                    "## Authorization to use Mubbi-Service\r\n" +
