...
{
    public class LogInUserBackofficeHandler : IRequestHandler<LogInUserBackofficeCommand, LogInUserBackofficeCommandResponse>
    {
        ...
        public LogInUserBackofficeHandler(IUnitOfWork unitOfWork, IMediatorHandler mediatorHandler, ITokenBuilderService tokenBuilderService, ICryptography cryptography)
        {
        ...
        public async Task<LogInUserBackofficeCommandResponse> Handle(LogInUserBackofficeCommand command, CancellationToken cancellationToken)
        {
            ...
            if (user == null)
            {
                ...
                return new LogInUserBackofficeCommandResponse();
            }
            ...
            return new LogInUserBackofficeCommandResponse() { UserId = user.Id, Token = token };
        }
    }
}