...
namespace Aluguru.Marketplace.Data.Migrations
{
    ...
    [Migration("20210128004426_Added_Product_InvalidDates")]
    partial class Added_Product_InvalidDates
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Aluguru.Marketplace.Catalog.Domain.InvalidDates", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Aluguru.Marketplace.Catalog.Domain.Product", b =>
                {
                    ...
                    b.Property<Guid>("InvalidDatesId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Aluguru.Marketplace.Rent.Domain.Order", b =>
                {
                    ...
                    b.Property<bool>("FreigthCalculated")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Aluguru.Marketplace.Catalog.Domain.InvalidDates", b =>
                {
                    b.HasOne("Aluguru.Marketplace.Catalog.Domain.Product", "Product")
                        .WithOne("InvalidDates")
                        .HasForeignKey("Aluguru.Marketplace.Catalog.Domain.InvalidDates", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
