...
namespace Mubbi.Marketplace.Data.Migrations
{
    ...
    [Migration("20200908031841_User_Removed_Contact_List")]
    partial class User_Removed_Contact_List
    {
            ...
            modelBuilder.Entity("Mubbi.Marketplace.Register.Domain.Contact", b =>
                {
                    b.HasOne("Mubbi.Marketplace.Register.Domain.User", "User")
                        .WithOne("Contact")
                        .HasForeignKey("Mubbi.Marketplace.Register.Domain.Contact", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
