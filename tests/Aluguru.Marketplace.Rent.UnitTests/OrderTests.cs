...
namespace Aluguru.Marketplace.Rent.Tests
{
    public class OrderTests
    {
        ...
        {
            var item = new OrderItem(Guid.NewGuid(), Guid.NewGuid(), "test", "test", "test-image", DateTime.Now, 1, 1, 100);
        ...
        {
            var itemA = new OrderItem(Guid.NewGuid(), Guid.NewGuid(), "test", "test", "test-image", DateTime.Now, 1, 1, 100);
            var itemB = new OrderItem(Guid.NewGuid(), Guid.NewGuid(), "test", "test", "test-image", DateTime.Now, 1, 1, 300);
