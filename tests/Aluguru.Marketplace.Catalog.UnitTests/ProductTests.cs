...
namespace Aluguru.Marketplace.Catalog.UnitTests
{
    public class ProductTests
    {
        ...
        {
            Assert.Throws<DomainException>(() => new Product(Guid.Empty, Guid.NewGuid(), null, "name", "name-uri", "description", ERentType.Indefinite, new Price(500000, 50000, null), true, 1, 2, 30, 1, new List<CustomField>() { new CustomField(EFieldType.Text, "fake") }));
        }

        [Fact]
        public void CreateProduct_WhenEmptyCategoryId_ShouldThrowDomainException()
        {
            Assert.Throws<DomainException>(() => new Product(Guid.NewGuid(), Guid.Empty, null, "name", "name-uri", "description", ERentType.Indefinite, new Price(500000, 50000, null), true, 1, 2, 30, 1, new List<CustomField>() { new CustomField(EFieldType.Text, "fake") }));
        }

        [Fact]
        public void CreateProduct_WhenEmptyName_ShouldThrowDomainException()
        {            
            Assert.Throws<DomainException>(() => new Product(Guid.NewGuid(), Guid.NewGuid(), null, "", "name-uri", "description", ERentType.Indefinite, new Price(500000, 50000, null), true, 1, 2, 30, 1, new List<CustomField>() { new CustomField(EFieldType.Text, "fake") }));
        }
        ...
        {
            Assert.Throws<DomainException>(() => new Product(Guid.NewGuid(), Guid.NewGuid(), null, "name", "name-uri", "", ERentType.Indefinite, new Price(500000, 50000, null), true, 1, 2, 30, 1, new List<CustomField>() { new CustomField(EFieldType.Text, "fake") }));
        }
        ...
        {
            Assert.Throws<DomainException>(() => new Product(Guid.NewGuid(), Guid.NewGuid(), null, "name", "name-uri", "description", ERentType.Indefinite, new Price(500000, 50000, null), true, -1, 2, 30, 1, new List<CustomField>() { new CustomField(EFieldType.Text, "fake") }));
        }

        [Fact]
        public void CreateProduct_WhenMinLocationTimeIsGreaterThanMaxLocationTime_ShouldThrowDomainException()
        {
            Assert.Throws<DomainException>(() => new Product(Guid.NewGuid(), Guid.NewGuid(), null, "name", "name-uri", "description", ERentType.Indefinite, new Price(500000, 50000, null), true, -1, 30, 15, 1, new List<CustomField>() { new CustomField(EFieldType.Text, "fake") }));
        }

        [Fact]
        public void CreateProduct_WhenMinNoticeRentDaysIsLessThanOne_ShouldThrowDomainException()
        {
            Assert.Throws<DomainException>(() => new Product(Guid.NewGuid(), Guid.NewGuid(), null, "name", "name-uri", "description", ERentType.Indefinite, new Price(500000, 50000, null), true, -1, 2, 30, 0, new List<CustomField>() { new CustomField(EFieldType.Text, "fake") }));
        }
        ...
        {
            return new Product(Guid.NewGuid(), Guid.NewGuid(), Guid.NewGuid(), "TestProduct", "test-product", "description", ERentType.Indefinite, new Price(500000, 50000, null), true, 1, 2, 30, 1, new List<CustomField> { new CustomField(EFieldType.Text, "Size") });
        }
    }
